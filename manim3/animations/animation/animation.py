...
class Animation(ABC):
    ...
    def launched(
        self: Self
    ) -> AnimationLaunchedCondition:
        return AnimationLaunchedCondition(self)

    def terminated(
        self: Self
    ) -> AnimationTerminatedCondition:
