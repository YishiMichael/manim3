...
#                side="right"
#            )
#            inlay_points = np.append(
#                SpaceUtils.lerp(points[indices], points[indices + 1])(sub_residues[:, None]),
#                points[-1:],
#                axis=0
#            )
#            return inlay_points
...
#        #    return LineString(inlay_points_center)
...
#                    LineString(inlay_points),
#                    LineString(np.average(inlay_points, axis=0, keepdims=True))
#                )
#                for line_string, residues in zip(multi_line_string_0._line_strings_, residues_list_0)
#                if (inlay_points := get_inlay_points(line_string, residues)) is not None
#            )
#            result.extend(
#                LineString.interpolate(
#                    LineString(np.average(inlay_points, axis=0, keepdims=True)),
